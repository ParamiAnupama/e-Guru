...
<div id="mySidenav" class="sidenav" style="font-style: 'kalam';">
        ...
        <div class="menulink">
            ...
            <a href="#Financial">Financial Overview</a>
        </div>
        ...
        <div class="menulink">
            <div class="image-icon">
                <img src="../Images/Session.png" alt="Create Subject Icon">
            </div>
            <a href="#manage-sessions">Manage Sessions</a>
        </div>
        ...
        <div class="menulink">
            <div class="image-icon">
                <img src="../Images/logout1.png" alt="Settings Icon">
            </div>
